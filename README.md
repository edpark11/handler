...
### Examples
- [golang-graphql-playground](https://github.com/edpark11/playground)
...
### Test
```bash
$ go get github.com/edpark11/handler
$ go build && go test ./...
